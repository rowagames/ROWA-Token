    ...
    Ownable
{
    ...
    // Function to create a snapshot, callable only by the owner.
    ...
    // Function to pause token transfers, callable only by the owner.
    ...
    // Function to unpause token transfers, callable only by the owner.
    ...
    // Function to start vesting, callable only by the owner.
