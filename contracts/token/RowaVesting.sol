...
// Importing required contracts from OpenZeppelin.
...
import "@openzeppelin/contracts/security/ReentrancyGuard.sol";  // Contract module that helps prevent reentrant calls.
import "@openzeppelin/contracts/access/Ownable.sol";  // Provides basic authorization control functions.
import "@openzeppelin/contracts/utils/math/Math.sol";  // Library for generic mathematical operations.
import "@openzeppelin/contracts/utils/Strings.sol";  // Library for string conversions.
...
contract RowaVesting is Ownable, ReentrancyGuard {
    ...
    constructor(
        ...
        require(RESERVE_FUND_ != address(0x0), "RESERVE_FUND address cannot be 0");
    ...
    function createPrivateSaleVesting(
        ...
        uint256 currentTime = block.timestamp;
        currentTime = currentTime + PRIVS_CLIFF_DURATION;
    ...
    function createSeedSaleVesting(
        ...
        uint256 currentTime = block.timestamp;
        currentTime = currentTime + SEEDS_CLIFF_DURATION;
